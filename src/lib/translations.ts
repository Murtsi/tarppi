...
export const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    tikettiSniperCookiePlaceholder: 'Paste your tiketti.fi cookies from DevTools...',
    tikettiSniperCookieHint: 'Paste your full cookie string from browser DevTools (F12 → Application → Cookies). Needed for auto-cart. Without cookies, you\'ll just get a sound alert.',
    ...
    tikettiSniperCookiePlaceholder: 'Liitä tiketti.fi-evästeet DevToolsista...',
    tikettiSniperCookieHint: 'Liitä koko evästeiden merkkijono selaimesta (F12 → Application → Cookies). Tarvitaan automaattiseen ostoskoriin. Ilman evästeitä saat vain äänihälytyksen.',
