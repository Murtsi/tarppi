...
export const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    scorerSubtitle: 'Paste event data (JSON) to score resell potential',
    scorerInputLabel: 'Event features (JSON array)',
    scorerInputPlaceholder: 'Paste JSON array of event objects here...\n[{"event_id": "...", "name": "...", ...}]',
    scorerAnalyze: '🔍 Analyze Events',
    scorerAnalyzing: 'Scoring...',
    scorerClear: 'Clear',
    scorerLoadSample: '📋 Load Sample Data',
    ...
    scorerNoResults: 'No results yet. Paste event data and click Analyze.',
    scorerParseError: 'Invalid JSON. Please paste a valid JSON array of event objects.',
    scorerEmptyArray: 'JSON array is empty. Please provide at least one event.',
    scorerMissingFields: 'Each event needs at least "event_id" and "name" fields.',
  },
    ...
    scorerSubtitle: 'Liitä tapahtumatiedot (JSON) ja arvioi jälleenmyyntipotentiaali',
    scorerInputLabel: 'Tapahtumaominaisuudet (JSON-taulukko)',
    scorerInputPlaceholder: 'Liitä JSON-taulukko tapahtumaobjekteista tähän...\n[{"event_id": "...", "name": "...", ...}]',
    scorerAnalyze: '🔍 Analysoi tapahtumat',
    scorerAnalyzing: 'Pisteytetään...',
    scorerClear: 'Tyhjennä',
    scorerLoadSample: '📋 Lataa esimerkkidata',
    ...
    scorerNoResults: 'Ei tuloksia vielä. Liitä tapahtumatiedot ja klikkaa Analysoi.',
    scorerParseError: 'Virheellinen JSON. Liitä kelvollinen JSON-taulukko tapahtumaobjekteista.',
    scorerEmptyArray: 'JSON-taulukko on tyhjä. Anna vähintään yksi tapahtuma.',
    scorerMissingFields: 'Jokainen tapahtuma tarvitsee vähintään "event_id"- ja "name"-kentät.',
  },
}
